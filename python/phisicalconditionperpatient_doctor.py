...
try:
        ...
        query=""" select physical_condition,count(*) as nb from patient where doctor_id=%s group by physical_condition ; """
        ...
        if len(sys.argv) > 2 and sys.argv[2]=="1":
                ...
                plt.savefig("images/phisicalconditionperpatient_doctor.png")    
