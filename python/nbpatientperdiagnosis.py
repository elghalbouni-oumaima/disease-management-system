...
try:
        ...
        # Personnalisation
        #plt.title('Top 7 Most Common Diagnoses Among Patients',fontsize=15,fontweight='bold')
        plt.xlabel('Most Popular Diagnoses',fontsize=13)
        ...
        if len(sys.argv) > 1 and sys.argv[1]=="1":
                ...
                plt.savefig("images/nbpatientperdiagnosis.png",dpi=300, bbox_inches='tight')
