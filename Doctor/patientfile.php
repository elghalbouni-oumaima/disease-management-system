...
<?php require_once "Home.php"?>
 <!-- prsonnel inf Start-->
                        ...
                        ?>
                                <div  class="profile-container" >
                                    <div class="img-profile">
                                        <div>
                                            <span ><strong style="font-size:18px;text-decoration:underline;padding-left:20px;">Registration Date :</strong>   <?php echo $row['registration_day']?></span>
                                        </div>
                                    ...
                                    <div class="personelinf-container">
                                        ...
                                        <div class="inf-container">
                                            ...
                                            <span style="width:20px" id="address">  <?php echo $row['address']?></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div  class="profile-container"  style="margin-top:20px;">
                                    ...
                                    <div class="inf-container">
                                                <span> <?php if($row['physical_condition']) echo $row['physical_condition']; else echo "Not available";?></span>
                                     ...
                                     <div class="inf-container">
                                                <span>  <?php if($row['smoking_alcohol']) echo $row['smoking_alcohol'];else echo "None";?></span>
        ...
        <section >
            <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_symptom" style="background-color: #4468f8;margin: 1rem 0 0 4rem; padding:8px 30px;font-weight:400;color:white; " id="addsymbtn">Add Symptom</button>
        </section>
        <!-- Symptom End-->
        ...
        <section>
                <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_diagnosis" id="adddiagbtn" style="background-color: #4468f8;margin: 1rem 0 0 4rem;padding:8px 30px; color:white;font-weight:400; ">Add Diagnosis</button>
        </section>
        <!-- Diagnosis End-->
        ...
        <section>
                <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_treatment" style="background-color: #4468f8;margin: 1rem 0 0 4rem;padding:7px 25px; color:white;font-weight:400; " id="addtreabtn">Add Treatment</button>
        </section>
        <?php }?>
        <!-- treatments End-->
</main>
