<?php include "Home.php"?>
    <div class="edit-contaner" >
        ...
        <form action="" method="post" style=" display: flex;flex-direction: column;">
            ...
            <label >BMI  : </label>
            <input type="nymber" name="bmi" value="<?php echo $row['bmi']?>"  >
            
            <label >Height (Cm)   : </label>
            <input type="number" name="height_cm" value="<?php if($row['height_cm']) echo $row['height_cm'];else echo 'None'?>"  >
            
            <label >Weight (kg)   : </label>
            <input type="number" name="weight_kg" value="<?php  if($row['weight_kg']) echo $row['weight_kg'];else echo 'None' ;?>"  >
