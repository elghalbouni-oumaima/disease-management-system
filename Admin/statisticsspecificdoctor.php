    ...
    <div class="statics-table"  style="margin-top:40px;" >
        <div class="statics-container" >
            <div class="static-head" >
                ...
                <form method="post">
                        <button onclick="openMatplotlib()" name="genderperyeardoctor" >
        ...
        <div class="statics-container" >
            <div class="static-head" style="align-items: center;margin-top:25px">
                ...
                <form method="post">
                        <button onclick="openMatplotlib()" name="phisicalconditionperpatient_doctor" >
                        <img src="../images/statics icon.png" alt="Icon" width="30" height="40"> 
                        </button>
                </form>
            </div>
    ...
    <div class="statics-table" style="margin-top:20px;">
        <div class="statics-container" >
            <div class="static-head" >
                ...
                <form method="post">
                        <button onclick="openMatplotlib()" name="nbdiagnosispermois_doctor" >
                        <img src="../images/statics icon.png" alt="Icon" width="30" height="40"> 
                        </button>
                </form>
            </div>
        ...
        <div class="statics-container" >
            <div class="static-head" >
                ...
                <form method="post">
                        <button onclick="openMatplotlib()" name="nbpatientperdiagnosis_doctor" >
                        <img src="../images/statics icon.png" alt="Icon" width="30" height="40"> 
                        </button>
                </form>
            </div>
